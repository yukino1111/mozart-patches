...
# Ramdisk
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/rootdir/fstab.hi3635.ramdisk:$(TARGET_COPY_OUT_RAMDISK)/fstab.hi3635 \
    $(DEVICE_PATH)/rootdir/mountpoint.keep:$(TARGET_COPY_OUT_ROOT)/cust/.mountpoint \
    $(DEVICE_PATH)/rootdir/mountpoint.keep:$(TARGET_COPY_OUT_ROOT)/3rdmodem/.mountpoint \
    $(DEVICE_PATH)/rootdir/mountpoint.keep:$(TARGET_COPY_OUT_ROOT)/3rdmodemnvm/.mountpoint \
    $(DEVICE_PATH)/rootdir/mountpoint.keep:$(TARGET_COPY_OUT_ROOT)/3rdmodemnvmback/.mountpoint \
    $(DEVICE_PATH)/rootdir/mountpoint.keep:$(TARGET_COPY_OUT_ROOT)/sec_storage/.mountpoint
